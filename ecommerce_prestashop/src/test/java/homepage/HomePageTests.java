...
public class HomePageTests extends BaseTests {
	...
	public void testIncluirProdutoNoCarrinho_ProdutoIncluidoComSucesso() {
		...
		// Converte o pre�o do produto de uma String para um numero Double
		...
		// Calcula o valor do Subtotal Multiplicando o pre�o do produto pela quantidade
	...
	public void testIrParaCarrinho_InformacoesPersistidas() {
		...
		capturarTela("testIrParaCarrinho_Informa��esPersistidas");
	...
	public void testIrParaCheckout_FreteMeioPagamentoEnderecoListadoOK() {
		...
		// Selecionar a op��o "pay by Check"
